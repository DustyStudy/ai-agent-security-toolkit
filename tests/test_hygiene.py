...
TEXT_SUFFIXES = {".py", ".md", ".yaml", ".yml", ".toml", ".txt", ".cfg", ".ini"}
SKIP_DIRS = {".git", ".venv", "venv", "__pycache__", ".mypy_cache", ".ruff_cache", "dist", "build"}
# Control (except tab/newline), format (zero-width, bidirectional overrides) and line/paragraph
# separator characters. Where a test needs one, spell it as an escape such as "\u200b".
